...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Karl.
...
def main():
    ...
    better_draw_circles(rg.Point(77,77),15)
    better_draw_circles(rg.Point(150,200),15)
    even_better_draw_circles(rg.Point(100,100),20,33,'green',3)
...
def even_better_draw_circles(point,radius,x,color,thickness):
    turtle = rg.SimpleTurtle()
    ...
    for k in range(1, x):  # k becomes 1, 2, 3, ... 10
