...
def try_methods_and_functions():
    apc=rg.SimpleTurtle('turtle')
    apc.pen=rg.Pen('blue',5)
    apc.backward(150)
    apc.speed=1
    draw_many_squares(apc,2,100,30)
    apc.speed=5
    apc.pen.color='red'
    draw_many_squares(apc,10,50,15)
    apc.speed=100
    apc.pen.thickness=35
    draw_many_squares(apc,8,300,60)
    apc.pen=rg.Pen('black',3)
    apc.backward(200)
    apc.draw_circle(30)
    apc.draw_square(50)
